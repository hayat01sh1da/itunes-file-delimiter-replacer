...
- CLI flags and delimiter-conversion logic remain stable within Ruby 4.0.x / Python 3.14.x. Any breaking change will be documented in [CHANGELOG.md](./CHANGELOG.md) before release.
